...
namespace Lab1._4
{
    public partial class Form1 : Form
    {
        ...
        public void Sound_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            player.URL = path[Songs.SelectedIndex];
        ...
        {
            player.settings.rate = Speed.Value;
        }
